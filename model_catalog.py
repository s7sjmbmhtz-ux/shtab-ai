...
MODELS: dict[str, ModelSpec] = {
    ...
    "cogvideox-5b": ModelSpec(
        ...
        video_durations=(), default_duration=None,
    ...
    "ltx-2-3": ModelSpec(
        ...
        video_durations=(6, 8, 10), default_duration=6,
    ...
    "kling-o3": ModelSpec(
        ...
        supports_input_image=True, supports_end_image=True,
        video_durations=(5,), default_duration=5,
    ...
    "veo-3-1-lite": ModelSpec(
        ...
        supports_input_image=True, supports_end_image=True,
        video_durations=(8,), default_duration=8,
...
# Защитный порог экономики: пакет нельзя случайно выставить дешевле
# 32 копеек за внутренний токен. Текущий максимальный пакет стоит
# 32,9 копейки за токен и остаётся самым выгодным для пользователя.
MIN_PACKAGE_TOKEN_PRICE_KOPEKS = 32


TOKEN_PACKAGES = {
    "start": {"title": "Старт", "tokens": 500, "price_rub": 249},
    "popular": {"title": "Популярный", "tokens": 1500, "price_rub": 599},
    "pro": {"title": "PRO", "tokens": 4000, "price_rub": 1390},
    "max": {"title": "MAX", "tokens": 10000, "price_rub": 3290},
}
